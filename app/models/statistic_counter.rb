class StatisticCounter
  ...
  def initialize
    @values = {}
    @uncommitted_values = {}                                                    # temporary cumulated values, must be committed by commit_uncommitted_increments
  end
  ...
  # increment events counter no matter if success or error
