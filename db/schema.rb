...
ActiveRecord::Schema[8.0].define(version: 2025_09_03_100000) do
  ...
  create_table "encryption_key_versions", comment: "Encryption key versions with values", force: :cascade do |t|
    ...
    t.datetime "start_time", null: false, comment: "Start time of key version to be used. Must be equal or higher than the start time of the previous version"
  ...
  create_table "event_logs", id: false, force: :cascade do |t|
    ...
    t.string "msg_key", limit: 4000
    t.datetime "created_at", null: false
    t.datetime "last_error_time", comment: "Last time processing resulted in error"
  ...
  create_table "heartbeats", comment: "Heartbeat of server instance to ensure uniqueness (only one running server allowed)", force: :cascade do |t|
    ...
    t.datetime "heartbeat_ts", null: false, comment: "The timestamp of the last heartbeat received from the server instance"
  ...
  create_table "schema_rights", force: :cascade do |t|
    ...
    t.index ["schema_id"], name: "fk_schema_rights_schema"
  ...
  create_table "schemas", comment: "Schemas allowed for use with MOVEX CDC by admin acount", force: :cascade do |t|
    ...
    t.datetime "last_trigger_deployment", comment: "Timestamp of last successful trigger deployment for schema (no matter if there have been changes for triggers or not)"
    t.integer "lock_version", precision: 38, default: 0, null: false, comment: "Version for optimistic locking"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "encryption_key_id", precision: 38
    t.index ["encryption_key_id"], name: "ix_schemas_encryption_key"
  ...
  create_table "statistics", comment: "Throughput statistics", force: :cascade do |t|
    ...
    t.datetime "end_timestamp", null: false, comment: "End of period where events are processed"
  ...
  create_table "tables", comment: "Tables planned for trigger creation", force: :cascade do |t|
    t.integer "schema_id", precision: 38, null: false, comment: "Reference to schema"
    ...
    t.index ["encryption_key_id"], name: "ix_tables_encryption_key"
  ...
  add_foreign_key "conditions", "tables", name: "fk_conditions_table"
  add_foreign_key "encryption_key_versions", "encryption_keys", name: "fk_encryption_key_versions_key"
  ...
  add_foreign_key "schemas", "encryption_keys", name: "fk_schemas_encryption_key"
  add_foreign_key "tables", "encryption_keys", name: "fk_tables_encryption_key"
