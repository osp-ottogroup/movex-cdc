...
ActiveRecord::Schema.define(version: 2021_01_25_000000) do
  ...
  create_table "statistics", comment: "Throughput statistics", force: :cascade do |t|
    ...
    t.integer "events_delayed_errors", precision: 38, default: 0, null: false, comment: "Number of erroneous single event processings ending another retry after delay"
