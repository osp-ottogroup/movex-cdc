class ExtendStatistics < ActiveRecord::Migration[6.0]
  def change
    add_column :statistics, :events_delayed_errors,  :integer, precision: 16, null: false, default: 0,  comment: 'Number of erroneous single event processings ending another retry after delay'
