  ...
  def up
    ...
    when 'ORACLE' then
      ...
      CREATE TABLE Event_Logs (
        ...
        PCTFREE 0
        INITRANS #{Trixx::Application.config.max_simultaneous_transactions}
        LOB(Payload) STORE AS (CACHE)
        #{"PARTITION BY RANGE (Created_At) INTERVAL( NUMTODSINTERVAL(#{Trixx::Application.config.partition_interval},'SECOND'))
