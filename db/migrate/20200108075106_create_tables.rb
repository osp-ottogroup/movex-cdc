class CreateTables < ActiveRecord::Migration[6.0]
  def change
    create_table :tables, comment: 'Tables planned for trigger creation' do |t|
      t.references  :schema,null: false, index: false,  comment: 'Reference to schema'
      ...
      t.string      :kafka_key_handling,  limit: 1,     null: false, default: 'N',  comment: 'Type of Kafka key handling for this table. Valid values: N=none, P=primary key, F=fixed value, T=Transaction ID, E=Expression'
