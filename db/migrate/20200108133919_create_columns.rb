class CreateColumns < ActiveRecord::Migration[6.0]
  def change
    create_table :columns, comment: 'Columns with flags for DML operation to trigger' do |t|
      ...
      t.string  :yn_log_insert, limit: 1,     null: false, default: 'N',  comment: 'Log this column at insert operation (Y/N)'
      t.string  :yn_log_update, limit: 1,     null: false, default: 'N',  comment: 'Log this column at update operation (Y/N)'
      t.string  :yn_log_delete, limit: 1,     null: false, default: 'N',  comment: 'Log this column at delete operation (Y/N)'
