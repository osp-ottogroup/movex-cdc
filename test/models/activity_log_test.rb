...
class ActivityLogTest < ActiveSupport::TestCase
  ...
  test "create activity_log" do
    ...
    ActivityLog.new(user_id: 1, schema_name: 'Schema1', table_name: 'Table1', action: 'Without column').save!
    ActivityLog.new(user_id: 1, schema_name: 'Schema1', action: 'Without table').save!
  end
