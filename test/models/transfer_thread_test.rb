...
class TransferThreadTest < ActiveSupport::TestCase
  ...
  test "process" do
    ...
    remaining_event_log_count = process_eventlogs(max_wait_time: 30, expected_remaining_records: 0, title: 'Regular processing of all records')
    ...
    remaining_event_log_count = process_eventlogs(max_wait_time: 30, expected_remaining_records: 1, title: 'Processing with one error record')
    ...
    remaining_event_log_count = process_eventlogs(max_wait_time: 30, expected_remaining_records: 0, title: 'Processing the one error record')
