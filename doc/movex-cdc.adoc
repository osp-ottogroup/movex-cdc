...
'mock' - A mock library only for testing purposes without a Kafka connection (events are processed / removed from queue but not transferred to a Kafka target) +
