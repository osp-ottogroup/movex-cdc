...
|KAFKA_PRODUCER_TIMEOUT|Timeout in milliseconds for Kafka producer to wait for response of broker. If timeout is reached then the transfer is retried.|60000
