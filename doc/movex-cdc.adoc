...
docker run --rm \
  ...
  registry.gitlab.com/otto-group-solution-provider/movex-cdc bundle exec rake ci_preparation:create_user
...
docker run -p 8080:8080 \
  ...
  registry.gitlab.com/otto-group-solution-provider/movex-cdc
...
This function is available in MOVEX-CDC's GUI and also as http API.
...
http://localhost:8080/import_export > movex-cdc-config.json

===== Import of configuation data =====
