 ...
 * Choose the kind of message key handling http://osp-silver.gitlab.io/oss/movex-cdc/movex-cdc.html#_using_kafka_keys_to_ensure_sequential_order_of_messages[(See documentation for details)]
...
http://osp-silver.gitlab.io/oss/movex-cdc/movex-cdc.html
