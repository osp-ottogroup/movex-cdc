...
// - all relative links are preixed with host:port of the baseHref if the relative link starts with /
// - all relative links are prefixed with the whole baseHref if relate link doe not start with /
